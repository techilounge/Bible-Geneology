...
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Chronology ambiguity treated as settled** — particularly Terah's age at Abraham's birth, which decides whether Noah and Abraham overlap at all | High. It changes headline claims the product is built around.       | Model the decision explicitly as a chronology _variant_ with its own record, document it in `DATA_SOURCING.md` §4, and surface it in the UI. Never let it be an implicit constant.  |
